...
SECRET_KEY = 'ul^t5-+7!2ts@f0*!j*(osz(c2#zy&3obmsf(aan49_#w=6$+g'
...
# EMAIL_HOST_USER = 'chuckfortest@163.com'  # 发件人（天天生鲜官方邮箱账号）
# EMAIL_HOST_PASSWORD = 'winter123'  # 邮箱客户端授权码，非邮箱登录密码
